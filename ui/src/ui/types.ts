export type UpdateAvailable = import("../metis-runtime/infra/update-startup.js").UpdateAvailable;
import type { CronJobBase } from "../metis-runtime/cron/types-shared.js";
import type { ConfigUiHints } from "../metis-runtime/shared/config-ui-hints-types.js";
import type {
  GatewayAgentRow as SharedGatewayAgentRow,
  SessionsListResultBase,
  SessionsPatchResultBase,
} from "../metis-runtime/shared/session-types.js";
export type { ConfigUiHint, ConfigUiHints } from "../metis-runtime/shared/config-ui-hints-types.js";
...
export type ToolCatalogProfile =
  import("../metis-runtime/gateway/protocol/schema/types.js").ToolCatalogProfile;
export type ToolCatalogEntry =
  import("../metis-runtime/gateway/protocol/schema/types.js").ToolCatalogEntry;
export type ToolCatalogGroup =
  import("../metis-runtime/gateway/protocol/schema/types.js").ToolCatalogGroup;
export type ToolsCatalogResult =
  import("../metis-runtime/gateway/protocol/schema/types.js").ToolsCatalogResult;
export type ToolsEffectiveEntry =
  import("../metis-runtime/gateway/protocol/schema/types.js").ToolsEffectiveEntry;
export type ToolsEffectiveGroup =
  import("../metis-runtime/gateway/protocol/schema/types.js").ToolsEffectiveGroup;
export type ToolsEffectiveResult =
  import("../metis-runtime/gateway/protocol/schema/types.js").ToolsEffectiveResult;
